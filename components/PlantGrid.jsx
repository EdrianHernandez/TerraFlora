        ...
        {PLANTS.map((plant) => (
          <div key={plant.id} className="plant-card group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-terra-200/50 transition-all duration-300 border border-terra-100 flex flex-col h-full">
            ...
            <div className="relative aspect-[4/5] overflow-hidden bg-terra-100">
              ...
              {/* Overlay Tags */}
              <div className="absolute top-3 left-3 flex flex-col gap-2 z-0">
                {plant.tags.map(tag => (
              ...
              <button className="absolute -bottom-8 right-4 bg-white text-terra-900 p-3 rounded-full shadow-lg opacity-100 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 hover:bg-moss-600 hover:text-white">
